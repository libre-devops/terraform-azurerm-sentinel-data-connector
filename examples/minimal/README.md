...
```hcl
# Minimal call: a freshly onboarded workspace and one data connector (Defender for Cloud, which is
# subscription-scoped and needs no extra licensing). Applied then destroyed in one CI run.
locals {
...
| Name | Description |
|------|-------------|
| <a name="output_data_connector_ids"></a> [data\_connector\_ids](#output\_data\_connector\_ids) | Map of connector name to id. |
<!-- END_TF_DOCS -->
